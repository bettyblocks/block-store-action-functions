  ...
  structure: [
    {
      ...
      options: [
        ...
        {
          type: 'PROPERTY',
          label: 'Data Label | Model 2',
          key: 'chartLabelPropertyTwo',
          value: '',
          configuration: {
            dependsOn: 'modelTwo',
            condition: {
