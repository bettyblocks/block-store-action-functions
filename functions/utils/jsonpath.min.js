          ...
          !(function (b, c) {
            ...
            function i(a) {
              return (
                ...
                92 === a ||
                (a >= 128 &&
                  eb.NonAsciiIdentifierPart.test(String.fromCharCode(a)))
              );
            }
            function j(a) {
              switch (a) {
            ...
            function m(a) {
              ...
              switch (a.length) {
                ...
                case 8:
                  return (
                    'function' === a || 'continue' === a || 'debugger' === a
                  );
                case 10:
                  return 'instanceof' === a;
                default:
            ...
            function p() {
              ...
              for (
                pb.comments &&
                ((a = ib - 2),
                (b = { start: { line: jb, column: ib - kb - 2 } }));
                ib < lb;
                      ...
                      case 42:
                        return (
                          (ib += 2),
                          {
                            type: $a.Punctuator,
                            value:
                              String.fromCharCode(f) + String.fromCharCode(a),
                            lineNumber: jb,
                            lineStart: kb,
                            start: e,
                            end: ib,
            ...
            function x(a) {
              for (var b = '0' + gb[ib++]; ib < lb && e(gb[ib]); )
                b += gb[ib++];
              return (
            ...
            function C() {
              ...
              for (
                b = '', c = '';
                ib < lb && ((a = gb[ib]), i(a.charCodeAt(0)));
            ...
            function Q(a) {
              if (
                ...
                else if (hb && k(a.value))
                  return void P(a, db.StrictReservedWord);
            ...
            function ia() {
              ...
              for (
                ...
                if (T('.'))
                  (d = fa()), (b = mb.createMemberExpression('.', b, d));
                else if (T('('))
                  (c = da()), (b = mb.createCallExpression(b, c));
                else {
                  if (!T('[')) break;
            ...
            function na() {
              ...
              if (
                ((a = nb), (i = la()), (d = nb), 0 === (e = ma(d, ob.allowIn)))
              )
                return i;
              for (
            ...
            function wa() {
              ...
              return (
                ...
                (a = va()),
                W(),
                mb.createVariableDeclaration(a, 'var')
              );
            }
            function xa(a) {
              var b, c;
            ...
            function Ka() {
              ...
              for (
                d = ob.inSwitch, ob.inSwitch = !0, e = !1;
                ib < lb && !T('}');
            ...
            function Pa() {
              var a,
                ...
                e = nb.type;
              if (
                (e === $a.EOF && Q(nb), e === $a.Punctuator && '{' === nb.value)
              )
                return sa();
            ...
            function Ra(a) {
              ...
              return (
                R(')'),
                { params: h, stricted: d, firstRestricted: a, message: g }
              );
            }
            function Sa() {
              var a,
            ...
            ($a = {
              ...
              (a.Syntax = (function () {
                ...
                return (
                  'function' == typeof Object.freeze && Object.freeze(b), b
                );
              })());
          });
        },
                  ...
                  performAction: function (a, b, d, e, f, g, h) {
                    ...
                    switch (f) {
                      ...
                      case 2:
                        return (
                          e.ast.set({
                            expression: { type: 'root', value: g[i - 1] },
                          }),
                          e.ast.unshift(),
                          e.ast.yield()
                        );
                      ...
                      case 24:
                        g[i].length > 1
                          ? e.ast.set({
                              expression: { type: 'union', value: g[i] },
                            })
                          : (this.$ = g[i]);
                        break;
                      case 25:
                      ...
                      case 28:
                        (this.$ = {
                          expression: { type: 'string_literal', value: g[i] },
                        }),
                          e.ast.set(this.$);
                        break;
                      case 29:
                  ...
                  return {
                    ...
                    next: function () {
                      ...
                      for (
                        ...
                        if (
                          ...
                          if (
                            ((b = c), (d = f), this.options.backtrack_lexer)
                          ) {
                    ...
                    performAction: function (a, b, c, d) {
                      switch (c) {
                        ...
                        case 10:
                          return (
                            (b.yytext = b.yytext.substr(1, b.yyleng - 2)), 32
                          );
                        case 11:
                          return (
                            (b.yytext = b.yytext.substr(1, b.yyleng - 2)), 33
                          );
                        case 12:
                          return 17;
                        case 13:
        ...
        function (a, b, c) {
          ...
          e.readFileSync &&
            ((f.moduleInclude = e.readFileSync(
              a.resolve('../include/module.js'),
            )),
            (f.actionInclude = e.readFileSync(
              a.resolve('../include/action.js'),
            ))),
            (b.exports = f);
        },
        { './dict': 2, fs: 12 },
      ...
      4: [
        function (a, b, c) {
          ...
          (q.prototype.initialize = function () {
            ...
            (q.prototype._fns['member-descendant-numeric_literal'] =
              q.prototype._fns['subscript-descendant-string_literal'] =
      ...
      13: [
        function (a, b, c) {
          (function (a) {
            ...
            (c.resolve = function () {
              for (
                var c = '', d = !1, f = arguments.length - 1;
                f >= -1 && !d;
                f--
              ) {
              ...
              (c.dirname = function (a) {
                if (('string' != typeof a && (a += ''), 0 === a.length))
                  return '.';
                for (
            ...
            var c = {},
              e = (function a(e, f) {
                ...
                if ('MemberExpression' === e.type) {
                  ...
                  if ('Identifier' === e.property.type)
                    return l[e.property.name];
                  var m = a(e.property);
                  return m === c ? c : l[m];
                }
                ...
                if ('FunctionExpression' === e.type) {
                  ...
                  return Function(w.join(', '), 'return ' + d(e)).apply(
                    null,
                    x,
                  );
                }
